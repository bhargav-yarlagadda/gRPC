...
type MessageList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       []string               `protobuf:"bytes,1,rep,name=message,proto3" json:"message,omitempty"` // A repeated field to store multiple messages
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HelloRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // The name to be greeted
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // The greeting message
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type NameList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Names         []string               `protobuf:"bytes,1,rep,name=names,proto3" json:"names,omitempty"` // A repeated field to store multiple names
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x03(\tR\amessage\"\"\n" +
...
var file_proto_greet_proto_goTypes = []any{
	...
	(*MessageList)(nil),   // 1: greet_service.MessageList
